...
export const About = () => {
  ...
  return (
    <div className='about-container' id ='about'>
        ...
        <p className='about-description mt-5'>Welcome to PRO INNOVENTIONS, where innovation meets precision in every solution. With a commitment to excellence, we are your trusted partner for Conveyor Belt Design, Process Automation, Manufacturing of Metal-Mechanical Solutions, and Engineering Parts Services.</p>
